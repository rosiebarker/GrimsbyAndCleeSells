...
// if everything is ok, try to upload file
  ...
  if (move_uploaded_file($_FILES["product_image"]["tmp_name"], $target_file)) {
    ...
    try {
        ...
        $sql = "INSERT INTO product (account_id, product_name, product_description, category_id, product_price, product_quantity, product_image) 
                VALUES (:account_id, :product_name, :product_description, :category_id, :product_price, :product_quantity, :product_image)";
        ...
        $stmt->bindValue(':account_id', $_SESSION ['accountid'], PDO::PARAM_STR);    
